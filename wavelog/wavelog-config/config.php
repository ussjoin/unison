...
*/
$config['hamqth_username'] = 'K3QB';
$config['hamqth_password'] = 'GO_LOOK_IN_1PASSWORD';
...
|
*/
$config['base_url']	= 'https://wavelog.hippo-acoustic.ts.net/';
...
|
*/
$config['encryption_key'] = 'LOOK_IN_1PASSWORD';
...
$config['disable_manual_lotw'] = true;
$config['disable_manual_eqsl'] = true;
$config['disable_manual_hrdlog'] = true;
$config['disable_manual_qrz'] = true;
